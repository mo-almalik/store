...
<h3 className="text-3xl text-black mb-4 capitalize font-bold">{t("about.title")}</h3>
    ...
    <div class="relative">
        <img src={assets.about} alt='about us' className=' rounded-t-full' />
        <div className='bg-light shadow-2xl p-5 rounded-lg absolute w-full bottom-1 md:-left-10 md:rtl:-right-10  transition-all duration-1000 '>
